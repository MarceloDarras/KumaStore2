...
function agregarAlCarritoClicked(event){
    ...
    console.log(titulo);
    var precio = item.getElementsByClassName('card-text2')[0];
    var imagenSrc = item.getElementsByClassName('card-image')[0].src;
...
let botonItem = document.getElementsByClassName("boton-item");


let carrito = [];


let nom = document.getElementsByClassName("titulo-item");
let nombre = nom[0];
let nomText = nombre.textContent;

let id = document.getElementsByClassName("id-item");
let idSelect = id[0];
let idText = idSelect.textContent;
